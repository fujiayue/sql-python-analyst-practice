...
项目完全离线运行：内置共享中心工单模拟数据，SQL 使用 DuckDB 执行，Python 题通过 `solve(...)` 自动评分。适合在 5 天到 1 周内集中练习“读题、查数、写代码、看反馈、复盘错题”的上机能力。

当前版本默认展示“冲刺推荐题”，把模板化加练题隐藏到单独筛选里，避免被低价值重复题淹没。
...
- 168 道训练题：其中 16 道冲刺题、65 道推荐题、103 道模板加练题。
- 题目按冲刺、核心、加练分层，并显示难度和考点标签。
